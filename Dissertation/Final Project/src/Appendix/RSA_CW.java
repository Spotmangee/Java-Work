package Appendix;
//own code taken from computer security coursework - 2016
...
public class RSA_CW    //main class
{
    ...
    public RSA_CW() {   //constructor for main class
    ...
    public static void main(String[] args) throws IOException {     //main function
        ...
        RSA_CW rsa = new RSA_CW();  //implementation of cipher within main
